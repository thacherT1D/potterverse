  ...
  return knex('characters').del()
    .then(() => {
      return knex('characters').insert([{
        ...
        "imageUrl": "http://i.imgur.com/lX3lE9V.jpg",
      },
      {
        "id": "2",
        "firstName": "Hermione",
        ...
        "imageUrl": "http://i.imgur.com/kvexDei.jpg",
      },
      {
        "id": "3",
        "firstName": "Ron",
        ...
        "imageUrl": "http://i.imgur.com/rY7RSAc.jpg",
      },
      {
        "id": "4",
        "firstName": "Ginny",
        ...
        "patronous": "Horse",
        "bloodStatus": "Pure-blood",
        "imageUrl": "http://i.imgur.com/YO9CWSl.jpg",
      },
      {
        "id": "5",
        "firstName": "Luna",
        ...
        "patronous": "Hare",
        "bloodStatus": "Pure-blood",
        "imageUrl": "http://i.imgur.com/11GYGVT.jpg",
      },
      {
        "id": "6",
        "firstName": "Neville",
        ...
        "bloodStatus": "Pure-blood",
        "imageUrl": "http://i.imgur.com/naqfkln.jpg",
      },
      {
        "id": "7",
        "firstName": "Dean",
        ...
        "patronous": "",
        "bloodStatus": "Half-blood",
        "imageUrl": "http://i.imgur.com/l87Gqdk.jpg",
      },
      {
        "id": "8",
        "firstName": "Seamus",
        ...
        "patronous": "Fox",
        "bloodStatus": "Half-blood",
        "imageUrl": "http://i.imgur.com/dXRY0lC.jpg",
      },
      {
        "id": "9",
        "firstName": "Albus",
        ...
        "patronous": "Phoenix",
        "bloodStatus": "Half-blood",
        "imageUrl": "http://i.imgur.com/G0mKTxy.jpg",
      },
      {
        "id": "10",
        "firstName": "Minerva",
        ...
        "patronous": "Phoenix",
        "bloodStatus": "Half-blood",
        "imageUrl": "http://i.imgur.com/sjgazI7.jpg",
      }
    ]);
  });
    // .then(() => {
    //   return knex.raw(
    //     "SELECT setval('id', (SELECT MAX(id) FROM characters));"
    //   );
    // });
};
